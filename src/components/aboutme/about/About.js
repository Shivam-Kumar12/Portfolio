          ...
          <Col md={7}>
            <Fade duration={3000}>
              <p className="home-about-body">
                My name is <b className="purple">Shivam Kumar </b> 
                  and I am a <b className="purple">Computer Science and Engineering </b> 
                    student at <b className="purple">Shree SwamiNarayn Institute of Technology,Gandhinagar,Gujarat</b> 
                <br />
                <br />
                        I am proficient in various programming languages such as &nbsp;
                  <b className="purple">
                    {" "}
                    C,HTML, CSS, JavaScript,React,Node Js,Express Js,Mongo Db,Java, Python.{" "}
                  </b>
                <br />
                <br />
